...
static int validpos (char *found) {
...
static int validtype (char *found) {
   int r = 0;
...
static void removePrts(char *str) {
...
static int validBool (char *found) {
...
static void vusersG1 () {
   FILE *fp = fopen ("entrada/users-g3.csv" , "r");
   FILE *users_ok = fopen ("saida/users-ok-g3.csv" , "w");
   char line[200000];
...
static void vcommitsG1 () {
   FILE *fp = fopen ("entrada/commits-g3.csv" , "r");
   FILE *commits_ok = fopen ("saida/commits-ok-g3.csv" , "w");
   char line[800];
   char *string, *found, *aux;
   int c_pal;
   int checker;
...
static void vreposG1 () {
   FILE *fp = fopen ("entrada/repos-g3.csv" , "r");
   FILE *repos_ok = fopen ("saida/repos-ok-g3.csv" , "w");
   char line[66000];
   char *string, *found, *aux;
   int c_pal;
   int checker;
